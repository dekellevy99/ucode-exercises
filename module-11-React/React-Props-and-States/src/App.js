...
class App extends Component {
  ...
  generateCompanyTags(companies){
    ...
    for(const company of companies){
      result.push(<Company name={company.name} revenue={company.revenue} key={company.name} />)
    }
      ...
      <div>
        ...
        <div className="ex-space">
          ...
          <div className="exercise" id="spotcheck-3">
            {companies.map(company => <Company name={this.upperCase(company.name)} revenue={company.revenue} key={company.name}/>)}
          </div>
        </div>
        ...
        <div className="ex-space">
          ...
          {this.state.companies.map(company => <Company name={this.upperCase(company.name)} revenue={company.revenue} key={company.name}/>)}
          </div>
        </div>
